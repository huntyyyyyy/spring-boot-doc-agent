---
title: Spike — Spec corpus MCP (read-only)
...
context dump and hallucination. **Refuse** product `verify` / writes / WASM
...
| Later Could | Rust schema/digest crate; Go corpus snapshot; WASM reader plugin |
