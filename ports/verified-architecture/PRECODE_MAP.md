...
| --- | --- | --- |
| 0 | `00-governance/` | DoR/DoD, claim tiers, promotion |
| 1 | `01-vision/`, `02-stakeholders/` | Problem + people |
| 2 | `03-requirements/`, `04-constraints/` | REQs ≠ constraints; QAS; OQs |
| 3 | `05-quality-architecture/`, `06-domain/` | ATAM + DDD |
| 4 | `07-system-design/` | C4, ports, ICD, ADR, options |
| 5 | `08-verification/`, `09-product-tours/` | L1–L3 + tours |
| 6 | `10-rag-corpus/`, `11-science-transfer/` | RAG contracts + locked science |
