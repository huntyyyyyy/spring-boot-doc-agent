...
Presenters live in ``quality_gate_presenters`` (E-UX1).
"""
...
from doc_engine.ci.quality_gate_presenters import publish_gates_summary
...
def main(argv: list[str] | None = None) -> int:
    ...
    publish_gates_summary([name for name, _ in planned], results)
    if not args.skip_coverage:
