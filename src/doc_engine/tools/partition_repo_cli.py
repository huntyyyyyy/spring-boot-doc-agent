...
def _build_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument(
        ...
        default=120000,
        help=(
            "Target max tokens per group (default: 120000; leave headroom under "
    ...
    ap.add_argument(
        ...
        default=False,
        help=(
            "Additionally exclude paths matched by the repo's own .gitignore, "
...
def _partition_and_write(args, repo_path: str, out_path) -> None:
...
def main():
    ...
    repo_path, out_path = _resolve_paths(args)
    _partition_and_write(args, repo_path, out_path)
