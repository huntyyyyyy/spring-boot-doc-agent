...
def _validate_manifest_shape_prelude(data):
    problems = []
...
def _validate_manifest_shape_core(data):
...
def validate_manifest_shape(data):
    ...
    _validate_manifest_shape_prelude(data)
    _validate_manifest_shape_core(data)
