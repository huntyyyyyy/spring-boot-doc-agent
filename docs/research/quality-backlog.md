...
| **E-IK0** | Intent Kernel — parked. Plan `process/50`; C4/SoS design `docs/design/intent-kernel-cas-apply-design-2026-08-13.md`; evidence `process/49`. **No Implement** in this repo (D-00=B greenfield). | `process/50` + design |
