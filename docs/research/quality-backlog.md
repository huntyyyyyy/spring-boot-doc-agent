...
| **E-LIE0** | Local-first verified agent — RE + Pilot lanes + **ATAM QAS/ADR/formal-boundary method** | `process/50–54` · [`e-lie0-requirements`](../design/e-lie0-requirements-2026-08-10.md) · [`adr/`](../design/adr/README.md) |
