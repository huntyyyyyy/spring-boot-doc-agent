...
deepwiki: Unknown (no DeepWiki MCP this run)
---
...
this Python CLI. DeepWiki cartography: **Unknown**.
...
| ID | Title | Relevance |
| --- | --- | --- |
| [2504.16057](https://arxiv.org/abs/2504.16057) | Automated Static Vulnerability Detection via a Holistic Neuro-symbolic Approach (MoCQ) | Multi-backend query synth for **Joern + CodeQL**; DSL subsetting + symbolic validator — pattern for pack ports, not merge SoR |
...
| [2401.01571](https://arxiv.org/abs/2401.01571) | CodeFuse-Query: A Data-Centric Static Code Analysis System for Large-Scale Organizations | Compile vs non-compile extraction cost; scale budgets |
...
| Item | Why Unknown |
| --- | --- |
| DeepWiki cartography of CodeQL / Semgrep / oasdiff orgs | No DeepWiki MCP this run |
