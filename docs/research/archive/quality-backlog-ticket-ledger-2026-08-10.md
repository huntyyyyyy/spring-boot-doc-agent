---
title: Quality backlog ticket ledger (archived snapshot)
status: ARCHIVE — not Active tip SoT
date: 2026-08-10
superseded_by: docs/research/quality-backlog.md
note: Frozen P0–P38 ticket tables from before the 2026-08-10 layout reshape. Use only for historical ticket IDs / verify strings.
---

# Archived ticket ledger (do not schedule from here)

**Operational SoT:** [`../quality-backlog.md`](../quality-backlog.md).
