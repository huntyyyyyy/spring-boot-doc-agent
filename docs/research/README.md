...
| **process/** | [`process/`](process/) | SDD, foundational SE, frameworks, dynamics, façade/research hooks, legacy remediation Spec, docs taxonomy, **watch/stalker agents**, **RAG problem-first inventory (E-RAG0)** → [`process/20-…`](process/20-rag-problem-first-retrieval-systems-2026-08-10.md) |
