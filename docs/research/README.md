...
| **modularity/** | [`modularity/`](modularity/) | Stage-0 ports, test-suite BCs, tools wave 2, AstGrepBackend split, **tach dependency blueprint**, **DDD repo-structure options + quality deep-dive (E-REPO0: 21+22)** |
