...
| --- | --- | --- |
| **method/** | [`method/paper-digest-framework.md`](method/paper-digest-framework.md), [`method/PAPER_DIGEST_TEMPLATE.md`](method/PAPER_DIGEST_TEMPLATE.md), [`papers/digests/`](papers/digests/) | **Paper digests** — type keys, sections, references walk, GitHub anti-bogus (principal Phase A) |
