...
| [code-intel/](code-intel/) | Code intelligence stages — **DRAFT** E-CX0 (S0 Serena + runbook + **2026-08-13 OCS grep log**, S1 not authorized · S1 facts · S2 verify-loop). No Implement on this tip |
