...
| [code-intel/](code-intel/) | Code intelligence — **DRAFT** E-CX0. Start: [C4](code-intel/adopted-landscape-c4-2026-08-13.md) + [schema](code-intel/adopted-entities-schema-2026-08-13.md). S0 grep log; S1 not authorized. No Implement on this tip |
