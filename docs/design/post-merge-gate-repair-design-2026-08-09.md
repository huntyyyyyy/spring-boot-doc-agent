...
status: DRAFT — SPEC GATE E-HOT0 pending Approve of HOT1–HOT12
...
do_not:
  - Implement product fixes before Approve of HOT1–HOT12
...
> **DRAFT — awaiting Approve of HOT1–HOT12.**
>
...
| Field | Value |
| --- | --- |
| Decisions | **HOT1–HOT12** pending Approve |
| Research SoT | process/21 (2026-08-09) |
...
Prefer **bounded hotfix epic E-HOT1** under HOT1–HOT12 after Approve; then resume **E-COH1** reshape. Refuse thrash, ceiling raises, and tach-map expansion in the hotfix tip.

## Decisions

See research memo §6 (HOT1–HOT12). Copy locked here on Approve.
